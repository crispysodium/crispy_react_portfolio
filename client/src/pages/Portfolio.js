...
function Portfolio() {
    const projects = [
        ...
        },
        {
            ...
            level: "Expert",
            intro: "I'm not sure if \"Expert\" is the right level because there's always more to learn in coding, but this was a culmination of the Full-Stack program. React is a very cool tool. This was an ambitious idea to code in 2 weeks, and I am proud of the work we finished.",
